...
copyright = '2018-2020, Re:VIEW developers team'
...
htmlhelp_basename = 'ReVIEWknowledgedoc'
...
latex_documents = [
    (master_doc, 'ReVIEWknowledge.tex', 'Re:VIEW knowledge Documentation',
     'Re:VIEW developers team', 'manual'),
]
...
man_pages = [
    (master_doc, 'reviewknowledge', 'Re:VIEW knowledge Documentation',
     [author], 1)
]
