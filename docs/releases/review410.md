...
2020年2月29日に令和最初の版となる「[Re:VIEW 4.1.0](https://github.com/kmuto/review/releases/tag/v4.1.0)」をリリースしました。
...
今回の Re:VIEW 4.1 では新機能はいくつかあるものの、4.0 の不具合の修正やテストの拡充など、安定性を重視しています。バージョン2、3系を使い続けている方も、ぜひ導入してお使いいただければと思います。
